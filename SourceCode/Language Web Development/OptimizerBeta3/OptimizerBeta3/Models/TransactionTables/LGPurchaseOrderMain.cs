...
{
    public class LGPurchaseOrderMain
    {
        [Key]
        ...
        public virtual LGPurchaseOrder PurchaseOrder { get; set; }
        ...
        [Display(Name = "Leather Goods Group", Description = "eather Goods Group")]
        [ForeignKey("GetLeatherGoodsGroup")]
        public int FKLeatherGoodsGroup { get; set; }
        public virtual LeatherGoodsGroup GetLeatherGoodsGroup { get; set; }
