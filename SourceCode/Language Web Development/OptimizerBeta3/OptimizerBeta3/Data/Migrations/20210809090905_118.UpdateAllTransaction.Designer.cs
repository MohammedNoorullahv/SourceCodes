...
namespace OptimizerBeta3.Data.Migrations
{
    ...
    [Migration("20210809090905_118.UpdateAllTransaction")]
    partial class _118UpdateAllTransaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OptimizerBeta3.Models.TransactionTables.AllTransaction", b =>
                {
                    ...
                    b.HasIndex("FKFromStage");

                    b.HasIndex("FKQuality");

                    b.HasIndex("FKStatus");

                    b.HasIndex("FKToStage");
            ...
            modelBuilder.Entity("OptimizerBeta3.Models.TransactionTables.AllTransaction", b =>
                {
                    b.HasOne("OptimizerBeta3.Models.MasterTables.LookUpMaster", "LookUpMasterFromStage")
                        .WithMany()
                        .HasForeignKey("FKFromStage")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("OptimizerBeta3.Models.MasterTables.LookUpMaster", "LookUpMasterToStage")
                        .WithMany()
                        .HasForeignKey("FKToStage")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("LookUpMasterFromStage");

                    b.Navigation("LookUpMasterQuality");

                    b.Navigation("LookUpMasterStatus");

                    b.Navigation("LookUpMasterToStage");
            ...
            modelBuilder.Entity("OptimizerBeta3.Models.TransactionTables.Invoice", b =>
                {
                    ...
                    b.HasOne("OptimizerBeta3.Models.MasterTables.PartyInfo", "DeliveryTo")
                        .WithMany()
                        .HasForeignKey("FKDeliveryTo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
