...
namespace SmartDeviceProject2inC.AHGroupDataSetTableAdapters {
    ...
    public partial class AbbrevTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[AbbrevTable] WHERE (([Abbrev_] = @Original_Abbrev_) AND ([Grou" +
                "p_] = @Original_Group_))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            global::System.Data.SqlClient.SqlParameter param = new global::System.Data.SqlClient.SqlParameter();
            param.ParameterName = "@Original_Abbrev_";
            ...
            param.ParameterName = "@Original_Group_";
            param.DbType = global::System.Data.DbType.AnsiString;
            param.IsNullable = true;
...
SELECT ID, Abbrev_, FullName_, Group_, CreatedBy, CreatedDate, ModifiedBy, ModifiedDate, EnteredOnMachineID, AllocatedTo, RecordNotes, ConfirmedBy, ConfirmedStatus, ApprovedStatus, SortingOrderNo, IsApproved, ApprovedBy, ApprovedOn, ModuleName FROM AbbrevTable WHERE (Abbrev_ = @Abbrev_) AND (Group_ = @Group_)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[AbbrevTable] SET [ID] = @ID, [Abbrev_] = @Abbrev_, [FullName_] = @FullName_, [Group_] = @Group_, [CreatedBy] = @CreatedBy, [CreatedDate] = @CreatedDate, [ModifiedBy] = @ModifiedBy, [ModifiedDate] = @ModifiedDate, [EnteredOnMachineID] = @EnteredOnMachineID, [AllocatedTo] = @AllocatedTo, [RecordNotes] = @RecordNotes, [ConfirmedBy] = @ConfirmedBy, [ConfirmedStatus] = @ConfirmedStatus, [ApprovedStatus] = @ApprovedStatus, [SortingOrderNo] = @SortingOrderNo, [IsApproved] = @IsApproved, [ApprovedBy] = @ApprovedBy, [ApprovedOn] = @ApprovedOn, [ModuleName] = @ModuleName WHERE (([Abbrev_] = @Original_Abbrev_) AND ([Group_] = @Original_Group_));
SELECT ID, Abbrev_, FullName_, Group_, CreatedBy, CreatedDate, ModifiedBy, ModifiedDate, EnteredOnMachineID, AllocatedTo, RecordNotes, ConfirmedBy, ConfirmedStatus, ApprovedStatus, SortingOrderNo, IsApproved, ApprovedBy, ApprovedOn, ModuleName FROM AbbrevTable WHERE (Abbrev_ = @Abbrev_) AND (Group_ = @Group_)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=KHLI-ERPLAP;Initial Catalog=AHGroup;User ID=erp;Password=KHLIerp1234;" +
                "";
        }
        ...
        public virtual int Delete(string Original_Abbrev_, string Original_Group_) {
            if ((Original_Abbrev_ == null)) {
                throw new global::System.ArgumentNullException("Original_Abbrev_");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[0].Value = ((string)(Original_Abbrev_));
            }
            if ((Original_Group_ == null)) {
                throw new global::System.ArgumentNullException("Original_Group_");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_Group_));
            }
        ...
        public virtual int Update(
            ...
            if ((Original_Abbrev_ == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_Abbrev_));
            }
            if ((Original_Group_ == null)) {
                throw new global::System.ArgumentNullException("Original_Group_");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_Group_));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_Abbrev_, 
                    string Original_Group_) {
            return this.Update(ID, Original_Abbrev_, FullName_, Original_Group_, CreatedBy, CreatedDate, ModifiedBy, ModifiedDate, EnteredOnMachineID, AllocatedTo, RecordNotes, ConfirmedBy, ConfirmedStatus, ApprovedStatus, SortingOrderNo, IsApproved, ApprovedBy, ApprovedOn, ModuleName, Original_Abbrev_, Original_Group_);
        }
    }
}
namespace AHGroupDataSetUtil {
    using System;
    using System.Data;
