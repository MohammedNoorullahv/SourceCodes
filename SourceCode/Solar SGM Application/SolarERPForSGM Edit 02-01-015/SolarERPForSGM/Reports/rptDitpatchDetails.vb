...
Public Class rptDitpatchDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SolarERPForSGM.rptDitpatchDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDitpatchDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDitpatchDetails = New rptDitpatchDetails
        rpt.Site = Me.Site
        Return rpt
    End Function
