...
Public Class rptERPTrackingv1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SolarERPForSGM.rptERPTrackingv1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptERPTrackingv1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptERPTrackingv1 = New rptERPTrackingv1
        rpt.Site = Me.Site
        Return rpt
    End Function
