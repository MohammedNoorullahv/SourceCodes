...
Public Class rptOrderPlanning
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SolarERPForSGM.rptOrderPlanning.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOrderPlanning
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrderPlanning = New rptOrderPlanning
        rpt.Site = Me.Site
        Return rpt
    End Function
