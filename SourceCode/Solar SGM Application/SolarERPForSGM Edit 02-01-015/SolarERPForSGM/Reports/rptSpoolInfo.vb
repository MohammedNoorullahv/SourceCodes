...
Public Class rptSpoolInfo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SolarERPForSGM.rptSpoolInfo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSpoolInfo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSpoolInfo = New rptSpoolInfo
        rpt.Site = Me.Site
        Return rpt
    End Function
