...
Public Class rptSalesOrderMain
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SolarERPForSGM.rptSalesOrderMain.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesOrderMain
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesOrderMain = New rptSalesOrderMain
        rpt.Site = Me.Site
        Return rpt
    End Function
