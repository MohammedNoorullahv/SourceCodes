...
Public Class rptSalesAnalysis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SolarERPForSGM.rptSalesAnalysis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesAnalysis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesAnalysis = New rptSalesAnalysis
        rpt.Site = Me.Site
        Return rpt
    End Function
