...
Public Class rptERPTrackingv1WS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SolarERPForSGM.rptERPTrackingv1WS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptERPTrackingv1WS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptERPTrackingv1WS = New rptERPTrackingv1WS
        rpt.Site = Me.Site
        Return rpt
    End Function
