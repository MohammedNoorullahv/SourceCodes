...
Public Class ccInvoicesWithDetailsWithCustomerArticle
...
#Region "Functions"
    ...
    Public Function LoadAllInvoices(ByVal sBuyerName As String, ByVal sArticleName As String) As DataTable
        ...
        sCmd.CommandText = "sgm_InvoiceDetailsWithCustArt"
        ...
        sCmd.Parameters.Add(New SqlParameter("@mSoleName", SqlDbType.VarChar)).Value() = sArticleName
