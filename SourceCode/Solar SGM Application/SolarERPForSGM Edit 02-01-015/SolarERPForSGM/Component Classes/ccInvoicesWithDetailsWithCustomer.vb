...
Public Class ccInvoicesWithDetailsWithCustomer
...
#Region "Functions"
    ...
    Public Function LoadAllInvoices(ByVal sBuyerName As String) As DataTable
        ...
        sCmd.CommandText = "sgm_InvoiceDetailsWithCust"
        ...
        ElseIf mdlSGM.sSelectOption = "G-C" Then
            sCmd.Parameters.Add(New SqlParameter("@mAction", SqlDbType.VarChar)).Value() = "G-C"
        End If
