    ...
    Friend Sub HandleException(ByVal strModule As String, ByVal e As Exception)
        ...
        Try
            strMessage = "Exception: " & e.Message & vbCrLf & vbCrLf & "Module: " & strModule & vbCrLf & _
                "Method:  " & e.TargetSite.Name & vbCrLf & vbCrLf & "Please Notify Tech Support @ Ext:116 about this Issue." & vbCrLf & _
            ...
            If gbErrShow Then
                MessageBox.Show(strMessage, strCaption, MessageBoxButtons.OK)
            End If
