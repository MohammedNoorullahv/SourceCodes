...
Public Class frmProductStockforInHouse
...
#End Region
    ...
    Private Sub cbPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbPrint.Click
        ...
        ngrdRowNo = grdSalesOrderV1.FocusedRowHandle

        If ngrdRowNo >= 0 Then
            If grdSalesOrderV1.GetDataRow(ngrdRowNo).Item("Department").ToString = "DISPATCH DEPARTMENT" Then
                mdlSGM.sSelectedOption = "PACKING"
            ElseIf grdSalesOrderV1.GetDataRow(ngrdRowNo).Item("Department").ToString = "PACKING DEPARTMENT" Then
                mdlSGM.sSelectedOption = "PACKING"
            ElseIf grdSalesOrderV1.GetDataRow(ngrdRowNo).Item("Department").ToString = "FINISHING DEPARTMENT" Then
                mdlSGM.sSelectedOption = "FINISH"
            End If

            mdlSGM.sReportType = "PRODUCT STOCK"
            frmReport.Show()
            frmReport1.Show()
        End If
    End Sub
    ...
    Private Sub InsertProductStock()
        myccProductStock.InsertProductStockInHouse()
    End Sub
End Class