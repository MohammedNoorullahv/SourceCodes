...
namespace BarcodeScann.ComponentClasses
{
    public class DBConnect
    {
        ...
        public void CheckUserAlredyLogin(string userName)
        {
            using (SqlConnection conn = new SqlConnection(sgm.connectionString))
            {
                try
                {
                    ...
                    //cmd.Parameters.Add(new SqlParameter("@mAction", SqlDbType.Char)).Value = "CHECKUSERALRDYLOG";
        ...
        public bool InsertUserAuthentication(UserAuthentication uAuth)
        {
            using (SqlConnection conn = new SqlConnection(sgm.connectionString))
            {
                object sRes = null;
                try
                {
                    ...
                    sRes = cmd.ExecuteNonQuery(); // ExecuteScalar();
        ...
        public bool UpdateUserAuthentication(UserAuthentication uAuth)
        {
            using (SqlConnection conn = new SqlConnection(sgm.connectionString))
            {
                conn.Open();
