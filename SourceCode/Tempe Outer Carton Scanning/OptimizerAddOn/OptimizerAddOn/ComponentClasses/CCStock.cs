...
{
    public partial class CCStock : Component
    {
        public CCStock()
        {
            InitializeComponent();
        ...
        public CCStock(IContainer container)
        {
            container.Add(this);
        ...
        public DataTable LoadUnAssignedMaterial()
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(MdlApp.ConnectionString))
                {
                    ...
                    cmd.Connection = conn;
                    cmd.CommandText = "SLI_Stock";
                    cmd.CommandType = CommandType.StoredProcedure;

                    cmd.Parameters.Add(new SqlParameter("@mAction", SqlDbType.VarChar)).Value = "SELUNASSNSTK";
        ...
        public DataTable LoadJobcardDemand(string sJobcardNo, string sMaterialFor)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(MdlApp.ConnectionString))
        ...
        public DataTable LoadSalesOrderDemand(string sSalesOrderNo, string sMaterialFor)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(MdlApp.ConnectionString))
        ...
        public void LoadExcessLimit()
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(MdlApp.ConnectionString))
                {
                    ...
                    cmd.Parameters.Add(new SqlParameter("@mAction", SqlDbType.VarChar)).Value = "SELXSLIMIT";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            if (ds.Tables[0].Rows[i]["FullName_"].ToString() == "A")
                            {
                                MdlApp.CategoryA = Convert.ToDecimal(ds.Tables[0].Rows[i]["Abbrev_"]);
                            }
                            else
                            {
                                if (ds.Tables[0].Rows[i]["FullName_"].ToString() == "B")
                                {
                                    MdlApp.CategoryB = Convert.ToDecimal(ds.Tables[0].Rows[i]["Abbrev_"]);
                                }
                                else
                                {
                                    if (ds.Tables[0].Rows[i]["FullName_"].ToString() == "C")
                                    {
                                        MdlApp.CategoryC = Convert.ToDecimal(ds.Tables[0].Rows[i]["Abbrev_"]);
                                    }
                                }
                            }
                        }
        ...
        public bool StockTransaction(StrTransferData strTransferData)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(MdlApp.ConnectionString))
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        string sSalesOrderNo = strTransferData.SalesOrderNo;
                        string sFromSalesOrderNo = "";// sFromJobcardNo.Substring(0, 19);
                        ...
                        cmd4.Parameters.Add(new SqlParameter("@mSalesOrderNo", SqlDbType.VarChar)).Value = sSalesOrderNo;
                        ...
                        cmd4.Parameters.Add(new SqlParameter("@mFromSalesOrderNo", SqlDbType.VarChar)).Value = sFromSalesOrderNo;
