...
Public Class frmSaraCPRODSummaryFDDinBigScreen
...
#End Region
    ...
    Private Sub LoadDailyProduction()
        Try
            ...
            If sInfo = "Hourly Production" Then
                lblDataInfo.Text = "Hourly Production Status"
            ...
            ElseIf sInfo = "Capacity Status" Then
                ...
                If dsSelCapacity.Tables(0).Rows(nRowNo).Item("Conveyor").ToString = "SC1" Then
                    lblCapacity.Text = "Conveyor No. 1"
                ElseIf dsSelCapacity.Tables(0).Rows(nRowNo).Item("Conveyor").ToString = "SC2" Then
                    lblCapacity.Text = "Conveyor No. 2"
                ElseIf dsSelCapacity.Tables(0).Rows(nRowNo).Item("Conveyor").ToString = "SC3" Then
                    lblCapacity.Text = "Conveyor No. 3"
                ElseIf dsSelCapacity.Tables(0).Rows(nRowNo).Item("Conveyor").ToString = "SC4" Then
                    lblCapacity.Text = "Conveyor No. 4"
                ElseIf dsSelCapacity.Tables(0).Rows(nRowNo).Item("Conveyor").ToString = "SC5" Then
                    lblCapacity.Text = "Conveyor No. 5"
                Else
                    lblCapacity.Text = ""
                End If
                ...
                nDelayBy = Math.Ceiling(nToBeProducedQty - Val(tbAchievedDay.Text))
                ...
                tbToAchieveHour.Text = Format(Math.Ceiling((Val(tbDifferenceDay.Text) / nBalHour)), "0.00")
    ...
    Private Sub cbSkip_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbSkip.Click
        nBalanceDuration = 0
    End Sub

    Private Sub cbExit_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbExit.Click
        End
    End Sub

    Private Sub lblElapsedHour_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblElapsedHour.Click
