...
Module modWebcam
    ...
    Public Declare Function SendMessage Lib "System32" Alias "SendMessageA" _
        (ByVal hwnd As Integer, ByVal wMsg As Integer, ByVal wParam As Integer, _
        <MarshalAs(UnmanagedType.AsAny)> ByVal lParam As Object) As Integer

    'Public Declare Function SetWindowPos Lib "user32" Alias "SetWindowPos" (ByVal hwnd As Integer, _
    Public Declare Function SetWindowPos Lib "System32" Alias "SetWindowPos" (ByVal hwnd As Integer, _
    ...
    Public Declare Function capCreateCaptureWindowA Lib "CoInstaller_x64.dll" _
    ...
    Public Declare Function capGetDriverDescriptionA Lib "CoInstaller_x64.dll" (ByVal wDriver As Short, _
