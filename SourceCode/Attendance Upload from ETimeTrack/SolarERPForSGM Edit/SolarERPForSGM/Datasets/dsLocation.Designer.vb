...
Partial Public Class dsLocation
    ...
    Partial Public Class LocationDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddLocationRow(ByVal CompanyCode As String, ByVal LocationCode As String, ByVal LocationName As String) As LocationRow
            Dim rowLocationRow As LocationRow = CType(Me.NewRow,LocationRow)
            Dim columnValuesArray() As Object = New Object() {CompanyCode, LocationCode, LocationName}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function FindByLocationCode(ByVal LocationCode As String) As LocationRow
            Return CType(Me.Rows.Find(New Object() {LocationCode}),LocationRow)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnLocationCode}, true))
            Me.columnCompanyCode.MaxLength = 50
            Me.columnLocationCode.AllowDBNull = false
            Me.columnLocationCode.Unique = true
            Me.columnLocationCode.MaxLength = 3
    ...
    Partial Public Class LocationRow
        ...
        Public Property CompanyCode() As String
            Get
                Try 
                    Return CType(Me(Me.tableLocation.CompanyCodeColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'CompanyCode' in table 'Location' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableLocation.CompanyCodeColumn) = value
            End Set
        End Property
        ...
        Public Property LocationCode() As String
            Get
                Return CType(Me(Me.tableLocation.LocationCodeColumn),String)
            End Get
            Set
                Me(Me.tableLocation.LocationCodeColumn) = value
            End Set
        End Property
        ...
        Public Function IsCompanyCodeNull() As Boolean
            Return Me.IsNull(Me.tableLocation.CompanyCodeColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetCompanyCodeNull()
            Me(Me.tableLocation.CompanyCodeColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace dsLocationTableAdapters
    ...
    Partial Public Class LocationTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Location] WHERE (((@IsNull_CompanyCode = 1 AND [CompanyCode] IS NULL"& _ 
                ") OR ([CompanyCode] = @Original_CompanyCode)) AND ([LocationCode] = @Original_Lo"& _ 
                "cationCode) AND ((@IsNull_LocationName = 1 AND [LocationName] IS NULL) OR ([Loca"& _ 
                "tionName] = @Original_LocationName)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CompanyCode", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CompanyCode", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_LocationCode", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "LocationCode", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Location] ([CompanyCode], [LocationCode], [LocationName]) VALUES (@C"& _ 
                "ompanyCode, @LocationCode, @LocationName);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CompanyCode, LocationCode, Lo"& _ 
                "cationName FROM Location WHERE (LocationCode = @LocationCode) ORDER BY CompanyCo"& _ 
                "de, LocationCode, LocationName"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CompanyCode", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CompanyCode", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Location] SET [CompanyCode] = @CompanyCode, [LocationCode] = @LocationCod"& _ 
                "e, [LocationName] = @LocationName WHERE (((@IsNull_CompanyCode = 1 AND [CompanyC"& _ 
                "ode] IS NULL) OR ([CompanyCode] = @Original_CompanyCode)) AND ([LocationCode] = "& _ 
                "@Original_LocationCode) AND ((@IsNull_LocationName = 1 AND [LocationName] IS NUL"& _ 
                "L) OR ([LocationName] = @Original_LocationName)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CompanyCode, Location"& _ 
                "Code, LocationName FROM Location WHERE (LocationCode = @LocationCode) ORDER BY C"& _ 
                "ompanyCode, LocationCode, LocationName"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CompanyCode", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CompanyCode", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@LocationCode", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "LocationCode", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_CompanyCode", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "CompanyCode", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_LocationCode", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "LocationCode", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        CompanyCode, LocationCode, LocationName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Location"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)& _ 
                "WHERE        (Level = '1')"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY CompanyCode, LocationCode, LocationName"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CompanyCode As String, ByVal Original_LocationCode As String, ByVal Original_LocationName As String) As Integer
            ...
            End If
            If (Original_LocationCode Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_LocationCode")
            Else
                Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_LocationCode,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal CompanyCode As String, ByVal LocationCode As String, ByVal LocationName As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(1).Value = CType(LocationCode,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal CompanyCode As String, ByVal LocationCode As String, ByVal LocationName As String, ByVal Original_CompanyCode As String, ByVal Original_LocationCode As String, ByVal Original_LocationName As String) As Integer
            If (CompanyCode Is Nothing) Then
            ...
            If (LocationCode Is Nothing) Then
                Throw New Global.System.ArgumentNullException("LocationCode")
            Else
                Me.Adapter.UpdateCommand.Parameters(1).Value = CType(LocationCode,String)
            End If
            If (LocationName Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_CompanyCode,String)
            End If
            If (Original_LocationCode Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_LocationCode")
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_LocationCode,String)
            End If
            If (Original_LocationName Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CompanyCode As String, ByVal LocationName As String, ByVal Original_CompanyCode As String, ByVal Original_LocationCode As String, ByVal Original_LocationName As String) As Integer
            Return Me.Update(CompanyCode, Original_LocationCode, LocationName, Original_CompanyCode, Original_LocationCode, Original_LocationName)
        End Function
    End Class
